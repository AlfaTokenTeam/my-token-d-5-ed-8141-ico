...
import "./MyTokenD5ED8141.sol";

contract MyTokenD5ED8141PreSale {
    MyTokenD5ED8141 public token;
    ...
    function MyTokenD5ED8141PreSale(
        MyTokenD5ED8141 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenD5ED8141(_token);
